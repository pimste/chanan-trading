...
const baseMetadata: Metadata = {
  title: 'Contact Us | Chanan Trading - Expert Tower Crane Solutions',
  description: 'Get in touch with Chanan Trading for professional tower crane sales, rental, installation, and maintenance services. Contact our Netherlands office at Kruisweg 8, Nuth, or our Israel office. Expert support for your construction projects.',
  openGraph: {
    title: 'Contact Chanan Trading - Expert Tower Crane Solutions',
    ...
    url: 'https://www.chanan-trading.com/en/contact',
    images: [
      {
        url: 'https://www.chanan-trading.com/images/optimized/cropped-Top-page2-potain6.webp',
        width: 1200,
        height: 630,
        alt: 'Contact Chanan Trading - Professional Tower Crane Services',
      }
    ],
  },
  twitter: {
