...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'services.quote.desc': '"Excellence in construction begins with the right foundation and the right tools." - This principle guides everything we do at Chanan Trading.',
    
    // About Page
    'about.title': 'About Chanan Trading',
    'about.subtitle': 'Your trusted partner for tower crane sales and services since 2015.',
    'about.story.title': 'Our Story',
    'about.story.image': 'Chanan Trading company headquarters',
    'about.story.p1': 'Chanan Trading was founded in 2015 with a simple mission: to provide reliable, high-quality tower cranes and exceptional service to the construction industry.',
    'about.story.p2': 'Over the past 48 years, we have built a reputation for reliability, technical and customer-focused service. Our understanding of construction projects and their unique challenges has allowed us to develop a comprehensive approach that covers all aspects of tower crane usage.',
    'about.story.p3': "Today, Chanan Trading proudly serves a diverse clientele, from small construction firms to large multinational companies, providing them with the right tower cranes and expertise they need to complete their construction projects safely and efficiently.",
    ...
    'about.vision.intro': 'We envision Chanan Trading as the preferred partner for tower crane solutions, recognized for:',
    ...
    'about.team.ceo.bio': 'With 48 years of experience in the construction and crane industry, Chanan Wolotzky began his career in 1977 by founding his own company, trading in used Earth Moving Equipment.',
    'about.team.ceo.bio2': 'From 2007 until 2015 he worked at COMACO LTD as Sales Manager/Business Developer. In 2015 until today, Chanan Trading was founded, specializing in trading used POTAIN tower cranes in partnership with NIBM TOWER CRANES B.V from the Netherlands.',
    'about.team.technical': 'Technical Director',
    'about.team.technical.bio': 'Emma brings 15 years of engineering expertise to Chanan Trading, ensuring all tower cranes meet the highest technical and safety standards.',
    'about.team.operations': 'Operations Manager',
    'about.team.operations.bio': 'Thomas oversees all operational aspects of Chanan Trading, from logistics and installation to maintenance and training.',
    'about.team.customer': 'Customer Relations',
    'about.team.customer.bio': 'Lisa ensures that every client receives personalized service and support throughout their engagement with Chanan Trading.',
    ...
    'services.overview.desc': 'Chanan Trading offers a full range of services to meet all your tower crane needs. Our integrated approach ensures that every aspect of your crane requirements is handled with expertise and attention to detail.',
  ...
  nl: {
    ...
    'services.quote.desc': '"Excellentie in de bouw begint met de juiste fundering en de juiste hulpmiddelen." - Dit principe stuurt alles wat we doen bij Chanan Trading.',
    
    // About Page
    'about.title': 'Over Chanan Trading',
    'about.subtitle': 'Uw betrouwbare partner voor torenkranen en diensten sinds 2015.',
    'about.story.title': 'Ons Verhaal',
    'about.story.image': 'Chanan Trading bedrijfszaken',
    'about.story.p1': 'Chanan Trading werd in 2015 opgericht met een eenvoudige missie: betrouwbare, hoogwaardige torenkranen en uitzonderlijke service te bieden aan de bouwindustrie.',
    'about.story.p2': 'Over de afgelopen 48 jaar hebben we een reputatie opgebouwd voor betrouwbaarheid, technische en klantgerichte service. Onze kennis van bouwprojecten en hun unieke uitdagingen heeft ons in staat gesteld een volledige benadering te ontwikkelen die alle aspecten van het gebruik van torenkranen dekt.',
    'about.story.p3': 'Vandaag is Chanan Trading trots om een divers klantenbestand te dienen, van kleine bouwfirma\'s tot grote multinationale bedrijven, die wij voorzien van de juiste torenkranen en expertise die ze nodig hebben om hun bouwprojecten veilig en efficiënt te realiseren.',
    ...
    'about.vision.intro': 'We zien Chanan Trading als de gewenste partner voor torenkranenolossingen, erkend voor:',
    ...
    'about.team.ceo.bio': 'Met 48 jaar ervaring in de bouw- en kranenindustrie begon Chanan Wolotzky zijn carrière in 1977 door zijn eigen bedrijf op te richten, handelend in gebruikte grondverzetmachines.',
    'about.team.ceo.bio2': 'Van 2007 tot 2015 werkte hij bij COMACO LTD als Sales Manager/Business Developer. In 2015 tot vandaag werd Chanan Trading opgericht, gespecialiseerd in de handel in gebruikte POTAIN torenkranen in partnerschap met NIBM TOWER CRANES B.V uit Nederland.',
    'about.team.technical': 'Technische Directeur',
    'about.team.technical.bio': 'Emma brengt 15 jaar ingenieurservaring aan Chanan Trading, waarborgend dat alle torenkranen voldoen aan de hoogste technische en veiligheidsstandaarden.',
    'about.team.operations': 'Operations Manager',
    'about.team.operations.bio': 'Thomas zorgt voor alle operationele aspecten van Chanan Trading, van logistiek en installatie tot onderhoud en training.',
    'about.team.customer': 'Klantrelaties',
    'about.team.customer.bio': 'Lisa zorgt ervoor dat elke klant een persoonlijke service en ondersteuning ontvangt tijdens hun betrokkenheid bij Chanan Trading.',
    ...
    'services.overview.desc': 'Chanan Trading biedt een volledig gamma van diensten om al uw torenkraanbehoeften te voldoen. Onze geïntegreerde benadering zorgt ervoor dat elk aspect van uw kraanvereisten wordt behandeld met deskundigheid en aandacht voor detail.',
    'services.step1.title': 'Intake',
  ...
  de: {
    ...
    'services.quote.desc': '"Exzellenz im Bauwesen beginnt mit dem richtigen Fundament und den richtigen Werkzeugen." - Dieses Prinzip leitet alles, was wir bei Chanan Trading tun.',
    
    // About Page
    'about.title': 'Über Chanan Trading',
    'about.subtitle': 'Ihr vertrauenswürdiger Partner für Turmkranen und Dienstleistungen seit 2015.',
    'about.story.title': 'Unsere Geschichte',
    'about.story.image': 'Chanan Trading Hauptsitz',
    'about.story.p1': 'Chanan Trading wurde 2015 gegründet mit einer einfachen Mission: zuverlässige, hochwertige Turmkrane und ausgezeichnete Service zu bieten an der Bauindustrie.',
    'about.story.p2': 'In den letzten 48 Jahren haben wir eine Reputation für Zuverlässigkeit, technische und kundenorientierte Service aufgebaut. Unsere Kenntnisse von Bauvorhaben und ihren einzigartigen Herausforderungen ermöglichten es uns, einen umfassenden Ansatz zu entwickeln, der alle Aspekte der Nutzung von Turmkranen abdeckt.',
    'about.story.p3': 'Heute ist Chanan Trading stolz darauf, eine vielfältige Kundschaft zu bedienen, von kleinen Baufirmen bis hin zu großen multinationalen Unternehmen, und ihnen die richtigen Turmkrane und das Fachwissen zur Verfügung zu stellen, die sie benötigen, um ihre Bauprojekte sicher und effizient zu verwirklichen.',
    ...
    'about.vision.intro': 'Wir sehen Chanan Trading als bevorzugten Partner für Turmkranenlösungen, erkennbar für:',
    ...
    'about.team.ceo.bio': 'Mit 48 Jahren Erfahrung in der Bau- und Kranindustrie begann Chanan Wolotzky seine Laufbahn 1977 durch die Gründung seines eigenen Unternehmens, Handel mit gebrauchten Erdbewegungsmaschinen.',
    'about.team.ceo.bio2': 'Von 2007 bis 2015 arbeitete er bei COMACO LTD als Sales Manager/Business Developer. In 2015 bis heute wurde Chanan Trading gegründet, spezialisiert auf den Handel mit gebrauchten POTAIN Turmkranen in Partnerschaft mit NIBM TOWER CRANES B.V aus den Niederlanden.',
    'about.team.technical': 'Technischer Direktor',
    'about.team.technical.bio': 'Emma bringt 15 Jahre Ingenieurserfahrung nach Chanan Trading, die sicherstellen, dass alle Turmkrane die höchsten technischen und Sicherheitsstandards erfüllen.',
    'about.team.operations': 'Operations Manager',
    'about.team.operations.bio': 'Thomas übernimmt alle operativen Aspekte von Chanan Trading, von Logistik und Installation bis zum Wartungs- und Evaluierungsauftrag.',
    'about.team.customer': 'Kundenbeziehungen',
    'about.team.customer.bio': 'Lisa sorgt dafür, dass jeder Kunde persönliche Service und Unterstützung während ihrer Beteiligung bei Chanan Trading erhält.',
    ...
    'services.overview.desc': 'Chanan Trading bietet ein umfassendes Spektrum an Dienstleistungen, um alle Ihre Turmkranbedürfnisse zu erfüllen. Unser integrierter Ansatz stellt sicher, dass jeder Aspekt Ihrer Krananforderungen mit Fachwissen und Liebe zum Detail behandelt wird.',
